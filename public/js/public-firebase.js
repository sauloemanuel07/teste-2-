...
import {connectAuthEmulator, getAuth, inMemoryPersistence, setPersistence} from "https://www.gstatic.com/firebasejs/12.17.0/firebase-auth.js";
...
async function initializePublicFirebase() {
  const config = await loadFirebaseConfig();
  const app = initializeApp(config, "oficlaro-public-view");
...
export const publicFirebaseReady = initializePublicFirebase();
